                ...
                <table className='mt-[0.7rem]'>
                    <thead>
                        <tr>
                            ...
                            <td className='p-0 m-0'>
                                <div className='w-[8rem] text-center border border-black border-l-0 border-b-0 text-[14px]'>MONDAY</div>
                                <p className='w-[8rem] text-center border border-black border-l-0 text-[11.5px] mt-[-3px]'>7:00AM - 9:00AM</p>
                            </td>
                            <td className='p-0 m-0'>
                                <div className='w-[8rem] text-center border border-black border-l-0 border-b-0 text-[14px]'>TUESDAY</div>
                                <p className='w-[8rem] text-center border border-black border-l-0 text-[11.5px] mt-[-3px]'>9:00AM - 10:00AM</p>
                            </td>
                            <td className='p-0 m-0'>
                                <div className='w-[8.1rem] text-center border border-black border-l-0 border-b-0 text-[14px]'>THURSDAY</div>
                                <p className='w-[8.1rem] text-center border border-black border-l-0 text-[11.5px] mt-[-3px]'>9:00AM - 10:00AM</p>
                            </td>
                            <td className='p-0 m-0'>
                                <div className='w-[8.1rem] text-center border border-black border-l-0 border-b-0 text-[14px]'>FRIDAY</div>
                                <p className='w-[8.1rem] text-center border border-black border-l-0 text-[11.5px] mt-[-3px]'>9:00AM - 10:00AM</p>
                            </td>
                            <td className='p-0 m-0'>
                                <div className='w-[8.1rem] text-center border border-black border-l-0 border-b-0 text-[14px]'>SATUDAY</div>
                                <p className='w-[8.1rem] text-center border border-black border-l-0 text-[11.5px] mt-[-3px]'>9:00AM - 10:00AM</p>
                            </td>
                            <td className='p-0 m-0'>
                                <div className='w-[8.1rem] text-center border border-black border-l-0 border-b-0 text-[14px]'>SUNDAY</div>
                                <p className='w-[8.1rem] text-center border border-black border-l-0 text-[11.5px] mt-[-3px]'>9:00AM - 10:00AM</p>
                            </td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td colSpan={2} className='m-0 p-0'>
                                <div className='h-[2.5rem] border border-black border-t-0 text-[14px] flex items-center justify-center'>0</div>
                            </td>
                            <td className='m-0 p-0'>
                                <div className='h-[2.5rem] border border-black border-t-0 border-l-0 text-[14px] flex items-center justify-center'>0</div>
                            </td>
                            <td className='m-0 p-0'>
                                <div className='h-[2.5rem] border border-black border-t-0 border-l-0 text-[14px] flex items-center justify-center'>0</div>
                            </td>
